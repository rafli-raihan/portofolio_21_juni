                        ...
                        <div class="col-xl-4">
                            <div
                                ...
                                <div
                                    ...
                                    tabindex="0">
                                    <img
                                        src="assets/images/services/services-img-3.jpg"
                                        alt="services"
                                        class="img-fluid" />
                                </div>
                                <div
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <ul class="list-unstyled mb-0 hstack gap-1">
                                            <li>
                                                <a class="hstack" href="javascript:void(0)"><iconify-icon
                                                        icon="solar:star-bold"
                                                        class="fs-6 text-dark"></iconify-icon></a>
                                            </li>
                                            <li>
                                                <a class="hstack" href="javascript:void(0)"><iconify-icon
                                                        icon="solar:star-bold"
                                    ...
                                    <div class="hstack gap-2">
                                        <ul class="list-unstyled mb-0 hstack gap-1">
                                            <li>
                                                <a class="hstack" href="javascript:void(0)"><iconify-icon
                                                        icon="solar:star-bold"
                                                        class="fs-6 text-white"></iconify-icon></a>
                                            </li>
                                            <li>
                                                <a class="hstack" href="javascript:void(0)"><iconify-icon
                                                        icon="solar:star-bold"
                                ...
                                <div
                                    ...
                                    <ul
                                        ...
                                        <li>
                                            <a
                                                href="#!"
                                                class="btn bg-white p-2 round-45 rounded-circle hstack justify-content-center"><img src="assets/images/svgs/icon-be.svg" alt="be" /></a>
                                        </li>
                                        <li>
                                            <a
                                                href="#!"
                                            ...
                                            <li class="hstack gap-3">
                                                <span
                                                    class="round-32 rounded-circle bg-primary flex-shrink-0 hstack justify-content-center"><iconify-icon
                                                        icon="lucide:check"
                                                        class="fs-6 text-dark"></iconify-icon></span>
                                ...
                                <div class="card-body p-7 p-xxl-5 d-flex flex-column gap-8">
                                    <div class="d-flex flex-column gap-6">
                                        <div class="hstack gap-3">
                                            ...
                                            <span class="badge text-bg-dark hstack gap-2"><iconify-icon
                                                    icon="lucide:flame"
                    ...
                    <div
                        ...
                        <div class="marquee-content d-flex align-items-center gap-8">
                            <div class="marquee-tag hstack justify-content-center">
                                <img
                                    src="assets/images/pricing/partners-1.svg"
                                    alt="partners"
                                    class="img-fluid" />
                            </div>
                            <div class="marquee-tag hstack justify-content-center">
                                <img
                                    src="assets/images/pricing/partners-2.svg"
                                    alt="partners"
                                    class="img-fluid" />
                            </div>
                            <div class="marquee-tag hstack justify-content-center">
                                <img
                                    src="assets/images/pricing/partners-3.svg"
                                    alt="partners"
                                    class="img-fluid" />
                            </div>
                            <div class="marquee-tag hstack justify-content-center">
                                <img
                                    src="assets/images/pricing/partners-4.svg"
                                    alt="partners"
                                    class="img-fluid" />
                            </div>
                            <div class="marquee-tag hstack justify-content-center">
                                <img
                                    src="assets/images/pricing/partners-5.svg"
                                    alt="partners"
                                    class="img-fluid" />
                            </div>
                            <div class="marquee-tag hstack justify-content-center">
